...
function buildHorizontal(node){
  ...
  /* drag + wheel — with click/drag discrimination so card clicks always land.
     Mouse only: touch already pans via native overflow scrolling, and a scripted
     scrollLeft on pointermove fights it (jitter, then no pointerup after pointercancel). */
